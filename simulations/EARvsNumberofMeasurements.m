...
M_R_Beam = Qbar_R * ones(size(M_T_Beam)); % Rx fixed at Max (8) for all points % Number of exhaustive-search training Rx (Full Training)/(Partial Training)
